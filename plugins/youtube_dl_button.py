...
async def youtube_dl_call_back(bot, update):
    ...
    tmp_directory_for_each_user = Config.DOWNLOAD_LOCATION + "/" + f'{ranom}' + str(update.from_user.id)
    if not os.path.isdir(tmp_directory_for_each_user):
        os.makedirs(tmp_directory_for_each_user)
    download_directory = tmp_directory_for_each_user + "/" + f'{ranom}' + custom_file_name
    command_to_exec = []
